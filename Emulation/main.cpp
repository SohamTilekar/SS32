...
CPU::CPU(Logger *logger, bool log)
    : logger(logger), ports(logger, log), log(log) {
    registers.PC.data = 0;
    flags = 0;
}
...
void CPU::ExecInstr() {
    ...
    if ((instr >> 28).to_ulong() == 0) {
        ...
        case 0: { // Add
            if (log)
                logger->log("Add : SR1 = " + std::to_string(SR1) +
        ...
        case 1: { // Subtract
            if (log)
                logger->log("Subtract : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data =
                registers.registers[SR1].data.to_ulong() -
        ...
        case 2: { // Multiply
            if (log)
                logger->log("Multiply : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data =
                registers.registers[SR1].data.to_ulong() *
        ...
        case 4: { // AND
            if (log)
                logger->log("And : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data =
        ...
        case 5: { // OR
            if (log)
                logger->log("Or : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data =
                registers.registers[SR1].data | registers.registers[SR2].data;
        ...
        case 7: { // NAND
            if (log)
                logger->log("Nand : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data = ~(registers.registers[SR1].data &
        ...
        case 8: { // XOR
            if (log)
                logger->log("Xor : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data =
                registers.registers[SR1].data ^ registers.registers[SR2].data;
        ...
        case 9: { // XNOR
            if (log)
                logger->log("Xnor : SR1 = " + std::to_string(SR1) +
                            ", SR2 = " + std::to_string(SR2) +
                            ", DR = " + std::to_string(DR));
            registers.registers[DR].data = ~(registers.registers[SR1].data ^
                                             registers.registers[SR2].data);
        ...
        case 12: { // Arithmetic Shift Right
            if (log)
                logger->log(
                    "Arithmetic Shift Right : SR1 = " + std::to_string(SR1) +
                    ", SR2 = " + std::to_string(SR2) +
                    ", DR = " + std::to_string(DR));
            registers.registers[DR].data =
        ...
        case 3: { // Greater Than or Equal
            if (log)
                logger->log(
                    "Greater Than or Equal : SR1 = " + std::to_string(SR1) +
                    ", SR2 = " + std::to_string(SR2));
            flags[2] = (registers.registers[SR1].data.to_ulong() >=
                        registers.registers[SR2].data.to_ulong());
            if (log)
        ...
        case 4: { // Less Than or Equal
            if (log)
                logger->log(
                    "Less Than or Equal : SR1 = " + std::to_string(SR1) +
                    ", SR2 = " + std::to_string(SR2));
            flags[2] = (registers.registers[SR1].data.to_ulong() <=
                        registers.registers[SR2].data.to_ulong());
            if (log)
...
int main(int argc, char *argv[]) {
    ...
    CPU cpu(logger, log_flag_provided);
